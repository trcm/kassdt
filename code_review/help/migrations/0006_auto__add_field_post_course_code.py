...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.course_code'
        db.add_column(u'help_post', 'course_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='posts', to=orm['review.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.course_code'
        db.delete_column(u'help_post', 'course_code_id')
