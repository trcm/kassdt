...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'help_post', 'user_id')

        # Adding field 'Post.by'
        db.add_column(u'help_post', 'by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='posts', to=orm['review.ReviewUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Post.user'
        db.add_column(u'help_post', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm['review.ReviewUser']),
                      keep_default=False)

        # Deleting field 'Post.by'
        db.delete_column(u'help_post', 'by_id')
