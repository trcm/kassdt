...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.multiple_submissions'
        db.add_column(u'review_assignment', 'multiple_submissions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.multiple_submissions'
        db.delete_column(u'review_assignment', 'multiple_submissions')
    ...
    models = {
        ...
        u'review.assignment': {
            ...
            'first_display_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 6, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'review_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 6, 0, 0)'}),
            'submission_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'submission_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 6, 0, 0)'})
        },
        u'review.assignmentsubmission': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 6, 0, 0)'}),
