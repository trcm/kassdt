...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FakeTestModel'
        db.create_table(u'review_faketestmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attrb', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'review', ['FakeTestModel'])


    def backwards(self, orm):
        # Deleting model 'FakeTestModel'
        db.delete_table(u'review_faketestmodel')
    ...
    models = {
        ...
        u'review.assignment': {
            ...
            'first_display_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'repository_format': ('django.db.models.fields.TextField', [], {}),
            'review_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'review_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
            'submission_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'submission_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'})
        },
        u'review.assignmentsubmission': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
        ...
        u'review.faketestmodel': {
            'Meta': {'object_name': 'FakeTestModel'},
            'attrb': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'review.reviewuser': {
