...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'review_submissionreview', (
            ...
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.AssignmentSubmission'])),
        ))
    ...
    models = {
        ...
        u'review.submissionreview': {
            ...
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['review.AssignmentSubmission']"})
        },
