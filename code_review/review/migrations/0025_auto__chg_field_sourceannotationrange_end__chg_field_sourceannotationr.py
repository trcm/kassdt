...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceAnnotationRange.end'
        db.alter_column(u'review_sourceannotationrange', 'end', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'SourceAnnotationRange.start'
        db.alter_column(u'review_sourceannotationrange', 'start', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'SourceAnnotationRange.end'
        db.alter_column(u'review_sourceannotationrange', 'end', self.gf('django.db.models.fields.TextField')())

        # Changing field 'SourceAnnotationRange.start'
        db.alter_column(u'review_sourceannotationrange', 'start', self.gf('django.db.models.fields.TextField')())
