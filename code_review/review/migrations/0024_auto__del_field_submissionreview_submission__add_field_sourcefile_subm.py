...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubmissionReview.submission'
        db.delete_column(u'review_submissionreview', 'submission_id')
        ...
        # Adding field 'SourceFile.submission'
        db.add_column(u'review_sourcefile', 'submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.AssignmentSubmission'], null=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SubmissionReview.submission'
        raise RuntimeError("Cannot reverse this migration. 'SubmissionReview.submission' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SubmissionReview.submission'
        db.add_column(u'review_submissionreview', 'submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.AssignmentSubmission']),
                      keep_default=False)
        ...
        # Deleting field 'SourceFile.submission'
        db.delete_column(u'review_sourcefile', 'submission_id')
    ...
    models = {
        ...
        u'review.assignment': {
            ...
            'first_display_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'review_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 13, 0, 0)'}),
            'submission_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'submission_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 13, 0, 0)'})
        },
        u'review.assignmentsubmission': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 13, 0, 0)'}),
        ...
        u'review.submissionreview': {
            'Meta': {'object_name': 'SubmissionReview'},
            'by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['review.ReviewUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'review_uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'submissions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['review.AssignmentSubmission']", 'symmetrical': 'False'})
        },
