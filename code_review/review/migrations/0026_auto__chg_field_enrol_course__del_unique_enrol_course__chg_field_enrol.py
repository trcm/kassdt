...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Enrol', fields ['user']
        db.delete_unique(u'review_enrol', ['user_id'])

        # Removing unique constraint on 'Enrol', fields ['course']
        db.delete_unique(u'review_enrol', ['course_id'])


        # Changing field 'Enrol.course'
        db.alter_column(u'review_enrol', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.Course']))

        # Changing field 'Enrol.user'
        db.alter_column(u'review_enrol', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.ReviewUser']))

    def backwards(self, orm):

        # Changing field 'Enrol.course'
        db.alter_column(u'review_enrol', 'course_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['review.Course'], unique=True))
        # Adding unique constraint on 'Enrol', fields ['course']
        db.create_unique(u'review_enrol', ['course_id'])


        # Changing field 'Enrol.user'
        db.alter_column(u'review_enrol', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['review.ReviewUser'], unique=True))
        # Adding unique constraint on 'Enrol', fields ['user']
        db.create_unique(u'review_enrol', ['user_id'])
    ...
    models = {
        ...
        u'review.enrol': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "''", 'to': u"orm['review.ReviewUser']"})
        },
        u'review.reviewuser': {
