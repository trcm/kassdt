...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'review_course', 'course_code',
                      self.gf('django.db.models.fields.CharField')(default='ABCD1234', max_length=10),
                      keep_default=False)

        # Adding field 'Course.course_name'
        db.add_column(u'review_course', 'course_name',
                      self.gf('django.db.models.fields.CharField')(default='Intro to learning', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.course_code'
        db.delete_column(u'review_course', 'course_code')

        # Deleting field 'Course.course_name'
        db.delete_column(u'review_course', 'course_name')
