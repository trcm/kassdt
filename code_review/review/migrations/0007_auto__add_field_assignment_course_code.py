...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.course_code'
        db.add_column(u'review_assignment', 'course_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.course_code'
        db.delete_column(u'review_assignment', 'course_code_id')
