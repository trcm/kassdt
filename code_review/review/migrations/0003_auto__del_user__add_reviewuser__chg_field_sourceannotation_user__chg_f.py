...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SourceAnnotation.user'
        db.alter_column(u'review_sourceannotation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.ReviewUser']))

        # Changing field 'AssignmentSubmission.by'
        db.alter_column(u'review_assignmentsubmission', 'by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.ReviewUser']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SourceAnnotation.user'
        db.alter_column(u'review_sourceannotation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.User']))

        # Changing field 'AssignmentSubmission.by'
        db.alter_column(u'review_assignmentsubmission', 'by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.User']))
