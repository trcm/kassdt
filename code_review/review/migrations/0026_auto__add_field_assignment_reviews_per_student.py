...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.reviews_per_student'
        db.add_column(u'review_assignment', 'reviews_per_student',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.reviews_per_student'
        db.delete_column(u'review_assignment', 'reviews_per_student')
