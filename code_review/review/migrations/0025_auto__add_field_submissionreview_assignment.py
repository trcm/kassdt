...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionReview.assignment'
        db.add_column(u'review_submissionreview', 'assignment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['review.Assignment'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionReview.assignment'
        db.delete_column(u'review_submissionreview', 'assignment_id')
