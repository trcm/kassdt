...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.course_name'
        db.alter_column(u'review_course', 'course_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Course.course_name'
        db.alter_column(u'review_course', 'course_name', self.gf('django.db.models.fields.CharField')(max_length=50))
