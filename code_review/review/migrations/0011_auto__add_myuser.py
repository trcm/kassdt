...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'myUser'
        db.create_table(u'review_myuser', (
            (u'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'review', ['myUser'])


    def backwards(self, orm):
        # Deleting model 'myUser'
        db.delete_table(u'review_myuser')
    ...
    models = {
        ...
        u'review.assignment': {
            ...
            'first_display_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'repository_format': ('django.db.models.fields.TextField', [], {}),
            'review_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'review_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'}),
            'submission_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'submission_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'})
        },
        u'review.assignmentsubmission': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'}),
