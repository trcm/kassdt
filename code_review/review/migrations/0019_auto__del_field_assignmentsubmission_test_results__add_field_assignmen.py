...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssignmentSubmission.test_results'
        db.delete_column(u'review_assignmentsubmission', 'test_results_id')

        # Adding field 'AssignmentSubmission.root_folder'
        db.add_column(u'review_assignmentsubmission', 'root_folder',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='assignment', unique=True, null=True, to=orm['review.SourceFolder']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssignmentSubmission.test_results'
        db.add_column(u'review_assignmentsubmission', 'test_results',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='assignment', unique=True, null=True, to=orm['review.SubmissionTestResults']),
                      keep_default=False)

        # Deleting field 'AssignmentSubmission.root_folder'
        db.delete_column(u'review_assignmentsubmission', 'root_folder_id')
    ...
    models = {
        ...
        u'review.assignment': {
            ...
            'first_display_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'repository_format': ('django.db.models.fields.TextField', [], {}),
            'review_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'review_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)'}),
            'submission_close_date': ('django.db.models.fields.DateTimeField', [], {}),
            'submission_open_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)'})
        },
        u'review.assignmentsubmission': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)'}),
