...
class RepoTests(TestCase):
    ...
    def test_traverse_tree(self):
        ...
        This test is not really necessary because it is tested 
        implicitly by 
        test_private_populate_db and test_public_populate_db. 
        '''
        pass 
    """

    def test_populate_from_local(self):
        '''Check that database gets populated correctly when assignment
        submission made by calling populate_from_local.
        '''
        ...
        repoObj = Repo.clone_from(url,directory)

        populate_from_local(directory, studentRepo, sub, relDir)

        # Test directory structure is as expected. 
