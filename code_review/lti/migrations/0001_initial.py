...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LTIProfile'
        db.create_table(u'lti_ltiprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True)),
            ('roles', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'lti', ['LTIProfile'])


    def backwards(self, orm):
        # Deleting model 'LTIProfile'
        db.delete_table(u'lti_ltiprofile')
