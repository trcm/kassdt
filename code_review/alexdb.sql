...
INSERT INTO `help_post` VALUES (1,'e7b91586-b2fe-4090-92ab-46c885a4cb28','OH NO DATABASE','SOUTH SUCKS. Mein database ist kaputt!!','2014-09-18 14:02:52','2014-09-18 14:02:52',NULL,1,'adfadf',40,1),(2,'e4eebbeb-7cb4-442d-b632-a59ec81116ab','OH NO DATABASE','SOUTH SUCKS. Mein database ist kaputt!!','2014-09-18 14:03:06','2014-09-18 14:03:09',41,1,'https://github.com/avadendas/public_test_repo.git',40,1),(3,'f00d03c7-eed8-4a5d-980a-a33a33652b5a','TEST ME','ladkjafl','2014-09-20 11:13:18','2014-09-20 11:13:23',42,1,'https://github.com/avadendas/public_test_repo.git',40,1);
...
INSERT INTO `lti_ltiprofile` VALUES (1,27,NULL),(2,28,NULL),(33,53,NULL);
...
CREATE TABLE `review_assignment` (
  ...
  `reviews_per_student` int(11) NOT NULL,
  `min_annotations` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `review_submissionreview`
--

DROP TABLE IF EXISTS `review_submissionreview`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `review_submissionreview` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `submission_review_uuid` varchar(36) NOT NULL,
  `review_by_id` int(11) NOT NULL,
  `submission_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `review_submissionreview_0684e977` (`review_by_id`),
  KEY `review_submissionreview_efe1f810` (`submission_id`),
  CONSTRAINT `review_by_id_refs_id_114c324b` FOREIGN KEY (`review_by_id`) REFERENCES `review_reviewuser` (`id`),
  CONSTRAINT `submission_id_refs_id_6826d3f3` FOREIGN KEY (`submission_id`) REFERENCES `review_assignmentsubmission` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `review_submissionreview`
--

LOCK TABLES `review_submissionreview` WRITE;
/*!40000 ALTER TABLE `review_submissionreview` DISABLE KEYS */;
INSERT INTO `review_submissionreview` VALUES (1,'63233370-1fe3-475a-b3d0-03e1a4bf8c89',2,23);
/*!40000 ALTER TABLE `review_submissionreview` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-09-22 11:17:22
